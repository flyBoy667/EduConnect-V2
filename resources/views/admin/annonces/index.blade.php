...
@section('content')
    <div class="container mt-5">
        ...
        <button class="btn btn-primary mb-4" data-bs-toggle="modal" data-bs-target="#addAnnonceModal">
            Ajouter une Annonce
        </button>

        <!-- Modal pour ajouter une annonce -->
        @include('shared.modals.annonce.addAnnonceModal')
        ...
        <div class="row">
            @foreach($annonces as $annonce)
                ...
                @include('shared.modals.annonce.editAnnonceModal', ['annonce' => $annonce])
            @endforeach
        </div>
    </div>
