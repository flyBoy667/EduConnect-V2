<div class="modal fade" id="createPersonnelModal" tabindex="-1" aria-labelledby="createPersonnelModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createPersonnelModalLabel">Ajouter un Personnel Administratif</h5>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="role_id" id="role_id" class="form-select">
                                    @foreach($roles as $id => $nom)
                                        <option
                                            value="{{ $id }}" {{ old('role_id') == $id ? 'selected' : '' }}>{{ $nom }}</option>
                                    @endforeach
                                </select>
                                @error('role_id')
                                <div class="text-danger">{{ $message }}</div>
